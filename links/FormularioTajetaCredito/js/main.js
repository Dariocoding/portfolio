...
// Rellenamos el select del year
const yearActual = new Date().getFullYear(),
      max = yearActual + 8;
    
for(let i = yearActual; i < max; i++) {
...
formulario.inputNumero.addEventListener('keyup', (e) => {
    ...
    // Volteamos la tarjeta para que el usuario para que vea el frente
	mostrarFrente();
});
...
// CCV Validandolo y poniendolo en la tarjeta
